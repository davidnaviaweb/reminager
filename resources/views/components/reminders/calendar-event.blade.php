<a href="{{route('reminders.show', $reminder)}}" wire:navigate
   class="flex-1 bg-gray-200 dark:bg-gray-700 overflow-hidden p-1 rounded cursor-pointer mb-2">
    <div class="flex flex-col sm:flex-row flex-1 justify-center sm:justify-start align-center">
        ...
        <span class="hidden text-base sm:inline ml-1 font-semibold truncate" title="{{$reminder->name}}">{{$reminder->name}}</span>
    </div>
    ...
    <div class="flex-1 justify-center sm:justify-start align-center hidden sm:flex mt-2 pt-3 border-t border-t-gray-500">
